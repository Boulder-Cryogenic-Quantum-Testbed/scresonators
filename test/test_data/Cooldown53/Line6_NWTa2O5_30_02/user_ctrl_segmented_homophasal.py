...
fcs = [ 5.727362,] #5.775325, 5.814963, 5.863787, 
         #6.254562, 6.303750, 6.348587, 6.418062]
# fcs = [ 5.814963, 5.863787, 6.254562, 6.303750, 6.348587, 6.418062]
# 
# 
...
# %% high power scan
high_powers_floats = np.arange(-10, -10, -2)  # about 2 secs/power
...
HPow_IFBW_kHz = 1.0
HPow_num_pts = 51
HPow_fnames = make_filenames(high_powers, freq_strs, temperatures, sample_name, HPow_segment_option, tag="")
...
measure_multiple_resonators(fcs, spans, delays, high_powers,
                             ...
                             Noffres = 50, Nf = 150, offresfraction = 0.8, 
...
# %% mid power scan
med_powers_floats = np.arange(-30, -50, -2)  # 7 secs per power
...
MPow_IFBW_kHz = 0.5
MPow_num_pts = 51
MPow_fnames = make_filenames(med_powers, freq_strs, temperatures, sample_name, MPow_segment_option, tag="")
...
low_powers_floats = np.arange(-50, -91, -10)  # about 7 mins/power
...
LPow_IFBW_kHz = 0.1
LPow_num_pts = 51
LPow_fnames = make_filenames(low_powers, freq_strs, temperatures, sample_name, LPow_segment_option, tag="")
...
measure_multiple_resonators(fcs, spans, delays, low_powers,
                            ...
                            adaptive_averaging = False, sample_name = sample_name,
                            runtime = 1, cal_set = None, start_delay = 0,
                            Noffres = 51, Nf = 151, offresfraction = 0.8, 
                            is_segmented = is_segmented,  bypass_janis = True, 
