...
##### XXX:
# manual_dir = r"c:\Users\Lehnert Lab\Documents\GoldDR_Data\Cooldown53\Line4_NWNb2O5_30_02\\100mK dataset"

manual_dir = r"c:\Users\Lehnert Lab\Documents\GoldDR_Data\Cooldown53\Line4_NWNb2O5_30_02"

#### XXX:
data_directory_idx = 2  # 0 thru 7 
...
elif manual_dir is not None:
    os.chdir(manual_dir)
    cur_dir_path = os.getcwd()
    cur_dir = os.path.basename(cur_dir_path)
    all_folder_paths = glob.glob("*GHz")
