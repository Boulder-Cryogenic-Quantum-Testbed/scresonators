...
def stitch_broadband(prefix, freq_band, freq_step, dstr, powers,
                    Tmxc=13, fscale=1e9, sparam='S21', manual_fnames=None, manual_dirs=None):
    """
...
if __name__ == '__main__':
    ...
    stitch_broadband("lower_"+prefix, [fcs[0]-spans[0]*1e-3,fcs[0]+spans[0]*1e-3], freq_step, dstr, powers,
                    Tmxc=24., fscale=1e9, sparam='S12', 
                    manual_fnames=[manual_fnames[0]], manual_dirs=[manual_dirs[0]])
    
    
    stitch_broadband("upper_"+prefix, [fcs[1]-spans[1]*1e-3,fcs[1]+spans[1]*1e-3], freq_step, dstr, powers,
                    Tmxc=24., fscale=1e9, sparam='S12', 
