...
def find_initial_guess(x, y1, y2, Method, output_path, plot_extra):
    ...
    if plot_extra:
        try:
            ...
            raise ValueError(">Error when trying to plot raw data and circle fit in ",
                  "find_initial_guess")
    ...
    if Method.method == 'DCM' or Method.method == 'PHI':
        try:
            ...
            if Method.method == 'DCM':
                ...
                raise RuntimeError(">Failed to find initial guess for method PHI.",
                      " Please manually initialize a guess")
        ...
        try:
            ...
            raise RuntimeError(">Failed to find initial guess for method DCM REFLECTION. ",
                  "Please manually initialize a guess")
        ...
        try:
            ...
            raise RuntimeError(">Failed to find initial guess for method INV. ",
                  "Please manually initialize a guess")
        ...
        try:
            ...
            raise RuntimeError(">Failed to find initial guess for method CPZM. ",
                  "Please manually initialize a guess")
    else:
...
def fit(resonator):
    ...
    try:
        ...
        print(f'Exception: {e}')
        raise ValueError("When trying to read data")
